...
* A species table with taxon codes (if the libraries are based on MMETSP format, it will be automatically generated by the proper script - tag TAXON_ID needed)
